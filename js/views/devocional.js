            ...
            <div class="view">
                ...
                <article class="devocional-hero reveal reveal-delay-1" aria-label="Alimento de Hoy">
                    ...
                    <div class="hero-actions">
                        ...
                        <button class="btn" onclick="LumenShare.alimentoDia()" aria-label="Compartir reflexión como imagen">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="9" cy="9" r="2"></circle><path d="M21 15l-5-5L5 21"></path></svg>
                            Imagen
                        </button>
                    </div>
                </article>
                ...
                <div class="devocional-grid">
                    ...
                    <section class="santo-card reveal reveal-delay-2" aria-label="Santo del día">
                        ...
                        <div class="santo-card-actions">
                            ...
                            <button class="btn btn-share" onclick="LumenShare.santoDia()" aria-label="Compartir el santo de hoy como imagen">
                                ${LumenIcons.share}
