                ...
                <div class="view">
                    ...
                    <div class="bento-grid">
                        ...
                        <div class="bento-box bento-wide reveal">
                            ...
                            <p>Crea tu cuenta, participa en actividades y sé parte de la familia Juvemar.</p>
                            <button class="btn btn-primary" style="margin-top: auto; width: auto; align-self: flex-start;" onclick="LumenUI.openModal('login-modal')">Iniciar Sesión / Registrarse</button>
                        </div>
                    </div>
                </div>
            `;
